...
#@when_not('nextcloud.dbrequested')
#def request_nextcloud_database(mysql):
#
#    status_set('maintenance',
#               'Requesting MySQL database for Nextcloud')
#
#    mysql.configure('nextcloud_db')
#
#    status_set('active', 'Nextcloud database requested')
#    set_flag('nextcloud.dbrequested')
